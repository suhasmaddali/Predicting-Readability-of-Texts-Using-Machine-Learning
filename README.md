...
In the dataframe, we find excerpts that contain the actual test in the dataframe. We have the output to be the target which is basically the difficult score for the excerpts.
